...
class DataIngestion:
    def __init__(self,data_ignestion_config:DataIngestionConfig):
        try:
            self.data_ingestion_config=data_ignestion_config
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("excited the train test split method of Data Ingestion class")
